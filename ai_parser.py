...
- **review_dates**: 단계별 심사 일정. 없으면 [].
  - 【공모전 정보】의 "심사기간" → {"label": "심사기간", "date": "심사기간 원문 그대로"}
  - 본문의 "1차 심사", "서류 심사", "발표 심사", "결과 발표" 등 단계별 일정 포함.
  - **date 필드는 원문 텍스트 그대로 저장하세요.** YYYY-MM-DD 변환 불필요.
    예: "7월 말", "2026.07.14 ~ 2026.08.28", "8월 중순", "8월 말 ~ 9월 초"
