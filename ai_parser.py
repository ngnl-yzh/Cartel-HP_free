...
규칙:
- 날짜: YYYY-MM-DD 형식. 연도 생략 시 현재 연도 사용. 없으면 null.
- 한국어 날짜(예: 2026년 6월 30일, 26.06.30, 6/30) 모두 파싱하세요.
- deadline: "접수 마감", "응모 마감", "제출 마감" 등에서 추출.
- start_date: "접수 시작", "공고일", "모집 시작" 등에서 추출.
- announcement_date: "발표", "결과 발표", "당선작 발표" 등에서 추출.
- review_dates: 1차 심사·2차 심사·서류 심사·발표 심사 등 단계별 심사 일정 배열. 없으면 [].
- prize: 상금·부상·시상 내역을 간결하게 요약 (예: "대상 500만원, 최우수상 300만원").
- tags: ["IT/SW","디자인","기획·마케팅","사회혁신","예술·문화","창업·스타트업","논문·학술","기타"] 중 해당하는 것만.
- description: 마크다운으로 정리. 응모 자격·주제·제출물·심사 기준·특이사항 포함. 최대 1500자.
